...
import net.runelite.client.plugins.dpscalc.beans.EquipmentSlotItem;
import net.runelite.client.plugins.dpscalc.beans.ItemStats;
...
public class Player implements Serializable {
	...
	boolean scythe() {
		if (currentSet.containsKey(3) && currentSet.get(3).getName().toLowerCase().contains("scythe of vitur")) {
			return true;
		} else {
			return false;
		}
